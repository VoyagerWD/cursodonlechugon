	...
	<tr>
		<td>
			<?php if ($producto->imagen != null): ?>
				<img style="max-width: 200px; max-height: 200px;" src="<?= base_url ?>uploads/images/<?= $producto->imagen ?>" class="img_carrito" />
			<?php else: ?>
				<img style="max-width: 200px; max-height: 200px;" src="<?= base_url ?>assets/img/camiseta.png" class="img_carrito" />
			<?php endif; ?>
		</td>
		<td>
